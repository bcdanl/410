...
<center>
a **nonlinear relationship** between income and pollution.
</center>
...
<div style="text-align:center; width: 60%; margin: auto;">
  <img src="https://bcdanl.github.io/lec_figs/quadratic-graph.png" alt="" style="max-width: 1000px; width: 100%; border-radius: 10px; box-shadow: 0 0 12px rgba(0,0,0,.15);">
</div>
